    ...
    public function yearslist(Request $request)
    {
        ...
        if ($type == 'year') {
            ...
            if ($class == 'nursery') {
                ...
                // $data = ["বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান", "ধর্ম ও নৈতিক শিক্ষা", "জীবন ও জীবিকা শিক্ষা", "ডিজিটাল প্রযুক্তি"];

                // $data = ["বাংলা", "ইংরেজি", "গণিত", "বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান", "ধর্ম ও নৈতিক শিক্ষা", "জীবন ও জীবিকা শিক্ষা", "ডিজিটাল প্রযুক্তি","স্বাস্থ্য ও সুরক্ষা","শিল্প ও সংস্কৃতি"];
            ...
            elseif ($class == 'nine' || $class == 'ten') {
                if ($group == 'science') {
                    $data = ["বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "পদার্থবিজ্ঞান", "রসায়ন", "জীব বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান", "ধর্ম ও নৈতিক শিক্ষা", "জীবন ও জীবিকা শিক্ষা", "উচ্চতর গণিত", "ডিজিটাল প্রযুক্তি"];
                } elseif ($group == 'humanities') {
                    $data = ["বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "বিজ্ঞান", "ভূগোল ও পরিবেশ", "অর্থনীতি", "বাংলাদেশ ও বিশ্ব সভ্যতার ইতিহাস", "ধর্ম ও নৈতিক শিক্ষা", "জীবন ও জীবিকা শিক্ষা", "ডিজিটাল প্রযুক্তি"];
