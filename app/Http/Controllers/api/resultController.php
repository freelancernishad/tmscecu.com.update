...
return redirect()->back();
        ...
        if ($r->exam_name == 'Weakly Examination') {
            ...
            if ($resultCount > 0) {
                ...
                for ($i = 0; $i < $count; $i++) {
                    ...
                    //  বাংলা  বাংলা ১ম   বাংলা ২য়   ইংলিশ    ইংলিশ ১ম   ইংলিশ ২য়  গনিত   বিজ্ঞান   রসায়ন   পদার্থ  জীব-বিজ্ঞান   ইতিহাস ও সামাজিক বিজ্ঞান   ইসলাম-ধর্ম   হিন্দু-ধর্ম   জীবন ও জীবিকা   তথ্য ও যোগাযোগ প্রযোক্তি
                    ...
                    } else if ($r->Subject[0] == 'ইতিহাস ও সামাজিক বিজ্ঞান') {
                    ...
                    } else if ($r->Subject[0] == 'জীবন ও জীবিকা') {
    ...
    public function GetSubject($class = '', $group = '')
    {
        ...
        if ($class == 'nursery') {
            ...
            $data = ["বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান", "ধর্ম ও নৈতিক শিক্ষা", "জীবন ও জীবিকা শিক্ষা", "ডিজিটাল প্রযুক্তি", "শারীরিক শিক্ষা ও স্বাস্থ্য", "চারু ও কারুকলা", "কর্ম ও জীবনমুখী শিক্ষা"];
