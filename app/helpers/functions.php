...
//   return "https://sandbox.ekpay.gov.bd/ekpaypg/v1?sToken=$sToken&trnsID=$trnx_id";
    ...
    function BanglaSubToEnglish($banglaSubject)
    {
        ...
        }elseif($banglaSubject=='জীবন ও জীবিকা শিক্ষা'){
...
function subjectCol($subject)
    {
        if($subject=='ইংরেজি'){
            ...
            $orginal = array("বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "বিজ্ঞান","পদার্থবিজ্ঞান", "রসায়ন", "জীব বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান","ভূগোল ও পরিবেশ", "অর্থনীতি", "বাংলাদেশ ও বিশ্ব সভ্যতার ইতিহাস", "ধর্ম ও নৈতিক শিক্ষা","ইসলাম-ধর্ম","হিন্দু-ধর্ম", "জীবন ও জীবিকা শিক্ষা", "উচ্চতর গণিত", "ডিজিটাল প্রযুক্তি","স্বাস্থ্য ও সুরক্ষা","শিল্প ও সংস্কৃতি");
            ...
            // $orginal = array("বাংলা ১ম","বাংলা ২য়","ইংলিশ ১ম","ইংলিশ ২য়","গনিত","বিজ্ঞান","পদার্থ","রসায়ন","ভূগোল","অর্থনীতি","ইতিহাস","ইতিহাস ও সামাজিক বিজ্ঞান","ধর্ম","ইসলাম-ধর্ম","হিন্দু-ধর্ম","জীবন ও জীবিকা","তথ্য ও যোগাযোগ প্রযোক্তি");
   ...
   $group = strtolower($group);
    ...
    if ($type == 'year') {
        ...
        if ($class == 'nursery') {
            ...
            $data = ["বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান", "ধর্ম ও নৈতিক শিক্ষা", "ডিজিটাল প্রযুক্তি", "জীবন ও জীবিকা শিক্ষা"];
        }
        elseif ($class == 'eight') {
            $data = ["বাংলা", "ইংরেজি", "গণিত", "বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান", "ধর্ম ও নৈতিক শিক্ষা", "ডিজিটাল প্রযুক্তি", "জীবন ও জীবিকা শিক্ষা"];
        }

        elseif ($class == 'nine' || $class == 'ten') {
            if ($group == 'science') {
                $data = ["বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "পদার্থবিজ্ঞান", "রসায়ন", "জীব বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান", "ধর্ম ও নৈতিক শিক্ষা", "ডিজিটাল প্রযুক্তি", "জীবন ও জীবিকা শিক্ষা", "উচ্চতর গণিত"];
            } elseif ($group == 'humanities') {
                $data = ["বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "বিজ্ঞান", "ভূগোল ও পরিবেশ", "অর্থনীতি", "বাংলাদেশ ও বিশ্ব সভ্যতার ইতিহাস", "ধর্ম ও নৈতিক শিক্ষা", "ডিজিটাল প্রযুক্তি", "জীবন ও জীবিকা শিক্ষা"];
            } elseif ($group == 'commerce') {

                $data = ["বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "বিজ্ঞান", "পদার্থ", "রসায়ন", "জীব-বিজ্ঞান", "ভূগোল", "অর্থনীতি", "ইতিহাস", "ইতিহাস ও সামাজিক বিজ্ঞান", "ধর্ম", "ডিজিটাল প্রযুক্তি", "জীবন ও জীবিকা শিক্ষা"];
            } else {
   ...
   $group = strtolower($group);
    $data = [];
        ...
        if ($class == 'nursery') {
            ...
            $data = ["বাংলা", "ইংরেজি", "গণিত", "বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান", "ধর্ম ও নৈতিক শিক্ষা", "জীবন ও জীবিকা শিক্ষা", "ডিজিটাল প্রযুক্তি"];
        } elseif ($class == 'nine' || $class == 'ten') {
            if ($group == 'science') {
                $data = ["বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "পদার্থবিজ্ঞান", "রসায়ন", "জীব বিজ্ঞান", "ইতিহাস ও সামাজিক বিজ্ঞান", "ধর্ম ও নৈতিক শিক্ষা", "জীবন ও জীবিকা শিক্ষা", "উচ্চতর গণিত", "ডিজিটাল প্রযুক্তি","শারীরিক শিক্ষা ও স্বাস্থ্য","চারু ও কারুকলা","ক্যারিয়ার শিক্ষা"];
            } elseif ($group == 'humanities') {
                $data = ["বাংলা ১ম", "বাংলা ২য়", "ইংরেজি ১ম", "ইংরেজি ২য়", "গণিত", "বিজ্ঞান", "ভূগোল ও পরিবেশ", "অর্থনীতি", "বাংলাদেশ ও বিশ্ব সভ্যতার ইতিহাস", "ধর্ম ও নৈতিক শিক্ষা", "জীবন ও জীবিকা শিক্ষা", "ডিজিটাল প্রযুক্তি","শারীরিক শিক্ষা ও স্বাস্থ্য","চারু ও কারুকলা","ক্যারিয়ার শিক্ষা"];
            } elseif ($group == 'commerce') {
